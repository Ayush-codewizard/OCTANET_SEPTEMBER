...
const FeatureTab = (props: (typeof tabs)[number] & ComponentPropsWithoutRef<'div'> & { selected: boolean } ) => {
  ...
  }, [props.selected, tabRef.current,xPercentage, yPercentage]);
  ...
  return (
    <div
      ...
      className="border border-white/15 flex p-2.5 cursor-pointer rounded-xl gap-2.5 items-center lg:flex-1 relative"
